...
public class PantallasMigradasTests
{
    ...
    public static TheoryData<string, string> Pantallas() => new()
    {
        ...
        { "/moduloReportes/panel-ejecutivo", "Panel ejecutivo" },
        { "/moduloReportes/ventas", "Ventas" },
        { "/moduloReportes/ventas-detalle", "Ventas detalladas" },
        { "/moduloReportes/ventas-horas", "Ventas entre horas" },
        { "/moduloReportes/clientes", "Clientes y comportamiento" },
        { "/moduloReportes/rentabilidad", "Rentabilidad comercial" },
        { "/moduloReportes/ventas-compras", "Ventas vs. compras" },
        { "/moduloReportes/cuentas-por-cobrar", "Cuentas por cobrar" },
        { "/moduloReportes/recuperacion-cxc", "Recuperación de cartera" },
        { "/moduloReportes/cabys", "Cumplimiento CABYS" },
        { "/moduloReportes/apartados", "Apartados y préstamos" },
        { "/moduloReportes/kpi-rutas", "KPI por ruta" },
        { "/moduloReportes/comisiones", "Comisiones" },
        { "/moduloReportes/caja", "Movimientos de caja" },
        { "/moduloReportes/arqueos-cierres", "Arqueos y cierres" },
        { "/moduloReportes/depositos", "Depósitos y cheques" },
        { "/moduloReportes/compras", "Compras y devoluciones" },
        { "/moduloReportes/gastos", "Gastos" },
        { "/moduloReportes/cuentas-por-pagar", "Cuentas por pagar" },
        { "/moduloReportes/inventario", "Existencias y lotes" },
        { "/moduloReportes/inventario-abc", "ABC y Pareto" },
        { "/moduloReportes/rotacion-inventario", "Rotación y reorden" },
        { "/moduloReportes/bonificaciones", "Bonificaciones y regalías" },
        { "/moduloReportes/mermas", "Mermas" },
        { "/moduloReportes/lotes", "Vencimiento de lotes" },
        { "/moduloReportes/trazabilidad", "Trazabilidad por lotes" },
        { "/moduloReportes/empaquetado", "Empaquetado y maquila" },
        { "/moduloReportes/auditoria", "Auditoría" },
